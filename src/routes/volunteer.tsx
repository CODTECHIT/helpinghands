...
export const Route = createFileRoute("/volunteer")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Volunteer With Us | Helping Hands Foundation" },
      {
        property: "og:description",
        content: "Field and remote volunteering roles with clear time commitments and training.",
      },
